<nav class="navbar" style="background-color: 7AFEFF">
    ...
    <div id="navMenubd-example" class="navbar-menu">
        ...
        <div class="navbar-end">
            ...
            @else
            <!-- BOUTON "Mes paramètres" , maintenant déplacé dans le Tableau de bord
                <div class="navbar-item has-dropdown is-hoverable">
                    <a class="navbar-link is-active">
                        Mes Paramètres
                    </a>
                    <div class="navbar-dropdown ">
                        <a class="navbar-item" href="{{ route('AdminUserShow', ['id'=>Auth()->user()->id]) }}">
                            <i class="fa fa-eye" aria-hidden="true"></i>
                             | Voir mon profil public
                        </a>
                        <a class="navbar-item " href="{{ route('AdminUserEdit', ['id'=>Auth()->user()->id]) }}">
                            <i class="fa fa-cog" aria-hidden="true"></i>
                             | Editer mes informations

                        </a>
                        <a class="navbar-item " href="{{route('AdminUserDelete', ['id'=>Auth()->user()->id])}}">
    ...
    <script> // Script pour faire apparaître le burger à la place de la navbar
